...
param storageAccountName string = 'st1${uniqueString(resourceGroup().id)}'
param appServicePlanName string = 'asp-scenario1-${uniqueString(resourceGroup().id)}'
param siteName string = 'func-scenario1-${uniqueString(resourceGroup().id)}'
